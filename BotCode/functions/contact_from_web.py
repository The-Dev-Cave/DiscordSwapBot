...
async def contact_channel_from_web(
    ...
    int_part_mem = await contact_web_plugin.bot.rest.fetch_member(
    ...
    msg_url = (
        await contact_web_plugin.bot.rest.fetch_message(
    ...
    channel = await contact_web_plugin.bot.rest.create_guild_text_channel(
        guild=guild_id,
        name=channel_name,
