...
@flare.text_select(
    ...
    options=[
        hikari.SelectMenuOption(
            label="Edit Post",
            value="edit",
            description="Edit Any Post Information",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            ...
            value="pending",
            description="Toggle Pending Status Of Post",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            label="Mark As Sold",
            value="sold",
            description="Mark Post As Sold & Delete Post",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            label="Remove Post",
            value="remove",
            description="Remove Post Without Marking As Sold",
            emoji=None,
            is_default=False,
        ),
    ],
...
@flare.text_select(
    ...
    options=[
        ...
        hikari.SelectMenuOption(
            label="Condition",
            description="Edit Condition Of Post",
            value="condition",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            label="Budget/Cost",
            description="Edit Budget/Cost Of Post",
            value="price",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            ...
            description="Edit Exchange Method",
            value="meetup",
            emoji=None,
            is_default=False,
        ),
        hikari.SelectMenuOption(
            ...
            description="Edit Payment Methods Of Post",
        ...
        hikari.SelectMenuOption(
            label="Image(s)",
            description="Add Or Remove Images For Post",
            value="images",
            emoji=None,
            is_default=False,
        ),
